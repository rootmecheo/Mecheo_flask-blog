...
def receive_data():
    if request.method == 'POST':
        ...
        sender_email = "mecheo.udemy@gmail.com"
        sender_password = "qawxospjhudrzvsk"
        recipient_email = "mecheo.udemy@gmail.com"
        message_subject = f"New message from {name}"
        message_body = f"Name: {name}\nEmail: {email}\nPhone Number: {number}\nMessage: {message}"

        # Create the email message
        email_message = f"Subject: {message_subject}\n\n{message_body}"
